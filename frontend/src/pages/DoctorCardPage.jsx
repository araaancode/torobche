  ...
  const doctorTemplates = [
    {
      ...
      description: 'کارت دیجیتال حرفه‌ای برای پزشکان عمومی با قابلیت نوبت‌دهی آنلاین',
      ...
      badge: 'پیشنهاد ویژه',
      location: 'تهران',
      consultationTime: '۱۵ دقیقه'
    },
    {
      id: 2,
      title: 'کارت متخصص قلب',
      description: 'قالب تخصصی برای پزشکان متخصص قلب با سیستم مشاوره آنلاین',
      ...
      badge: 'تخصصی',
      location: 'اصفهان',
      consultationTime: '۲۰ دقیقه'
    },
    {
      id: 3,
      title: 'کارت ارتوپدی',
      description: 'قالب ویژه پزشکان ارتوپد با امکانات نمایش نمونه‌کارها',
      image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80',
      specialty: 'ارتوپدی',
      experience: '8+ سال',
      availability: 'ویزیت در منزل',
      rating: 4.7,
      features: ['گالری نمونه‌کار', 'نوبت‌دهی اضطراری', 'مشاوره تلفنی', 'پزشک جایگزین'],
      popular: true,
      badge: 'پرطرفدار',
      location: 'مشهد',
      consultationTime: '۲۵ دقیقه'
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 lg:mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight mb-4 lg:mb-6">
            ...
            <br />
            <span className="text-gray-900 dark:text-white">حرفه‌ای و تخصصی</span>
          </h1>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl p-3 shadow-lg border border-white/50 dark:border-gray-700">
            <div className="text-center">
              <div className="text-lg font-black text-gray-900 dark:text-white">۵۰۰+</div>
              <div className="text-gray-600 dark:text-gray-400 text-sm">پزشک فعال</div>
            </div>
            <div className="w-px h-8 bg-gradient-to-b from-transparent via-gray-300 dark:via-gray-600 to-transparent" />
            <div className="text-center">
              <div className="text-lg font-black text-gray-900 dark:text-white">۹۹٪</div>
              <div className="text-gray-600 dark:text-gray-400 text-sm">رضایت مراجعین</div>
            </div>
            <div className="w-px h-8 bg-gradient-to-b from-transparent via-gray-300 dark:via-gray-600 to-transparent" />
            <div className="text-center">
              <div className="text-lg font-black text-gray-900 dark:text-white">۲۴/۷</div>
              <div className="text-gray-600 dark:text-gray-400 text-sm">پشتیبانی</div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 right-4 text-right">
                  ...
                  <p className="text-white/90 text-sm drop-shadow-lg">{template.specialty}</p>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  ...
                  <div className="flex items-center gap-1 bg-gray-50/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-xl p-2 justify-center">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 text-sm">{template.consultationTime}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between text-sm mb-4">
                  ...
                  <div className="flex items-center gap-1 bg-blue-50/80 dark:bg-blue-900/30 backdrop-blur-sm rounded-xl px-3 py-2">
                    ...
                    <span className="text-blue-700 dark:text-blue-300 font-medium">{template.availability}</span>
                  </div>
                </div>
        ...
        {filteredTemplates.length === 0 && (
          <div className="text-center py-16 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-3xl shadow-xl border border-white/50 dark:border-gray-700">
            <PiUserCircle className="text-6xl text-gray-300 dark:text-gray-600 mx-auto mb-4" />
