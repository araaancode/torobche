...
import { PiUser, PiLock, PiEye, PiEyeSlash, PiArrowRight, PiRocket } from 'react-icons/pi';
            ...
            <div className="text-center mb-12">
              <div className="flex justify-center mb-6 hover-lift">
                <div className="relative">
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl glass-card">
            ...
            <div className="glass-card rounded-3xl p-8 shadow-2xl hover-lift">
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      className="w-full glass-effect rounded-2xl px-4 py-4 pr-12 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center space-x-2 rtl:space-x-reverse text-sm text-gray-600">
                    <input type="checkbox" className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500 glass-effect" />
                    <span>مرا به خاطر بسپار</span>
                  </label>
                  <a href="/forgot-password" className="text-sm gradient-text font-medium transition-colors duration-300 hover-lift">
                ...
                <button
                  type="submit"
                  className="w-full group relative bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 rounded-2xl font-bold transition-all duration-300 hover-lift shadow-2xl overflow-hidden flex items-center justify-center space-x-2 rtl:space-x-reverse"
                >
              ...
              <div className="text-center">
                <p className="text-gray-600">
                  حساب کاربری ندارید؟{' '}
                  <a href="/register" className="gradient-text font-bold transition-colors duration-300 hover-lift">
                    ثبت‌نام کنید
                  </a>
                </p>
              </div>
